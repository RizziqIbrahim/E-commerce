				...
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							...
							<a href="../welcome/product/macaroni-pizza" class="site-btn sb-white">TRY IT</a>
							<a href="../welcome/product/macaroni-pizza" class="site-btn sb-line">DISCOVER</a>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							...
							<a href="../welcome/menu" class="site-btn sb-white">GET IT</a>
							<a href="../welcome/menu" class="site-btn sb-line">DISCOVER</a>
						</div>
					</div>
					<div class="offer-card text-white">
						<span>Disc From</span>
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							...
							<a href="../welcome/sort-by-category/beverages" class="site-btn sb-white">GET IT</a>
							<a href="../welcome/sort-by-category/beverages" class="site-btn sb-line">DISCOVER</a>
						</div>
					</div>
					<div class="offer-card text-white">
						<span>Disc From</span>
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-6 col-lg-7 text-white">
							...
							<a href="../welcome/product/cappucino-coffee" class="site-btn sb-white">GET IT</a>
							<a href="../welcome/product/cappucino-coffee" class="site-btn sb-line">DISCOVER</a>
						</div>
					</div>
					<div class="offer-card text-white">
		...
		<div class="container">
			...
			@foreach($latests  as $key => $latest)
				<div class="product-item">
					<div class="pi-pic">
						<img src="{{ asset('img/product/'.$latest->foto_makanan) }}" alt="{{$latest->nama_makanan}}">
						<div class="pi-links">
							<a href="{{ route('product.addToCart', ['id' => $latest->id]) }}" class="add-card"><i class="flaticon-bag"></i><span>ADD TO CART</span></a>
						</div>
					</div>
					<div class="pi-text">
						<a href="{{ route('show-user',$latest->slug_food)}}">
	...
	<section class="banner-section">
		<div class="container">
			<div class="banner set-bg" data-setbg="{{asset('/img/banner-bg.jpg')}}">
				...
				<a href="../welcome/product/macaroni-pizza" class="site-btn">TRY NOW</a>
			</div>
		</div>
	</section>
	<!-- Banner section end  -->

...
@section('content')
        <div class="container-fluid">
            ...
            <div class="row text-center justify-content-center animate__animated animate__bounce animate_delay-2s">
                <h3 class="mt-3"><span style="color: #ff6600;">About</span>&nbsp;<span style="color: purple;">Madinatul Quran Team</span></h3>
            </div>
            <div class="row mt-lg-5 mb-lg-5 mr-5 h-20 animate__animated animate__fadeInLeft">
            ...
            <div class="row mt-lg-5 mb-4 justify-content-center align-content-center animate__animated animate__bounce animate_delay-2s">

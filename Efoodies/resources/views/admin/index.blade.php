                ...
                <div class="row">
                 <div class="label"> Overview</div>
                    <div class="col-6">
                        <div class="overview">
                            <div class="user-total">
                                <div class="icon"></div>
                               <i class="flaticon-profile float-left"></i>
                               <div class="row ml-3">
                                    <div class="angka pt-4 pl-5">{{$users->count()}}</div>
                                    <div class="pt-2 pl-5">Jumlah Pengguna</div>
                               </div>
                            </div>
                        </div>    
                    </div>
                    <div class="col-6">
                        ...
                        <div class="user-total">
                                <div class="icon"></div>
                               <i class="flaticon-shopping-cart float-left"></i>
                               <div class="row ml-3">
                                    <div class="angka pt-4 pl-5">{{$ordersAdmin->count()}}</div>
                                    <div class="pt-2 pl-5">Jumlah Pesanan</div>
                               </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="label">Last Orders</div>
            <div class="items">

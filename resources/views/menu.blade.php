			...
			<div class="row">
				<div class="col-lg-3 order-2 order-lg-1">
                    ...
                    <div class="filter-widget mb-0">
                            ...
                            <ul class="category-menu">
                                <li><a href="{{ route('ghigh',['sort'=>'high_low']) }}">From Highest Price</a></li>
                            </ul>
                            <ul class="category-menu">
                                <li><a href="{{ route('glow',['sort'=>'low_high']) }}">From Lowest Price</a></li>
                            </ul> 
                    </div>	
                </div>
						...
						<div class="col-lg-4 col-sm-6">
							<div class="product-item">
								<div class="pi-pic">
									...
									<img src="{{ asset('img/product/'.$all->foto_makanan)}}" width="263.75"height="395.63" alt="{{ $all->nama_makanan}}">
									<div class="pi-links">	
								...
								<div class="pi-text">
									<h6>{{$all->harga}}</h6>
									<p><a href="{{ route('show',$all->slug_food)}}" class="text-dark">{{$all->nama_makanan}}</a></p>
								</div>
							</div>
						</div>
						@endforeach
